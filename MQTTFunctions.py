...
def startWirelessMQTTClient():
    ...
    state.WirelessMQTTClientConnected = (
        False  # global variable for the state of the connection
    )
    ...
    state.WirelessMQTTClient.on_connect = (
        on_WirelessMQTTClientconnect  # attach function to callback
    )
    state.WirelessMQTTClient.on_message = (
        on_WirelessMQTTClientmessage  # attach function to callback
    )
