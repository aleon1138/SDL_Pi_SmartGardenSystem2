...
def getStateJSON():
    ...
    now = datetime.now()
    data = {}
    data["SmartGardenSystemVersion"] = config.SGSVERSION
    ...
    data["SolarMaxIndoorTemperature"] = state.SolarMaxIndoorTemperature
    data["SolarMaxIndoorHumidity"] = state.SolarMaxIndoorHumidity
