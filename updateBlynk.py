...
def blynkInit():
    ...
    try:
        ...
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V39", data=put_body
        )
        time.sleep(0.5)
        put_body = "?value=No Wireless Unit Selected"
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V40", data=put_body
        )
        if config.manual_water == False:
            # set the label to disabled
            label = "Disabled"
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V41?offLabel=" + label
            )
            if DEBUGBLYNK:
            ...
            r = requests.get(
                config.BLYNK_URL
                + config.BLYNK_AUTH
                + "/update/V41?offBackColor=%230000FF"
            )  # Blue
            if DEBUGBLYNK:
        ...
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V5?color=%23FF0000"
        )  # Red
...
def updateStaticBlynk():
    ...
    r = requests.put(
        config.BLYNK_URL + config.BLYNK_AUTH + "/update/V60",
        data=put_body,
        headers=put_header,
    )
    ...
    put_body = json.dumps([val])
    r = requests.put(
        config.BLYNK_URL + config.BLYNK_AUTH + "/update/V61",
        data=put_body,
        headers=put_header,
    )
    ...
    put_body = json.dumps([val])
    r = requests.put(
        config.BLYNK_URL + config.BLYNK_AUTH + "/update/V62",
        data=put_body,
        headers=put_header,
    )
...
def blynkEventUpdate():
    try:
        ...
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V10",
            data=put_body,
            headers=put_header,
        )
        if DEBUGBLYNK:
...
def blynkTerminalUpdate(entry):
    try:
        ...
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V26",
            data=put_body,
            headers=put_header,
        )
        if DEBUGBLYNK:
...
def blynkStateUpdate():
    try:
        ...
        put_body = json.dumps([val])
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V1",
            data=put_body,
            headers=put_header,
        )
        ...
        if state.lastMainReading != "Never":
            ...
            r = requests.put(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V11",
                data=put_body,
                headers=put_header,
            )
            if DEBUGBLYNK:
            ...
            put_body = json.dumps([val])
            r = requests.put(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V12",
                data=put_body,
                headers=put_header,
            )
            ...
            put_body = json.dumps([val])
            r = requests.put(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V14",
                data=put_body,
                headers=put_header,
            )
            ...
            put_body = json.dumps([val])
            r = requests.put(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V15",
                data=put_body,
                headers=put_header,
            )
        ...
        put_body = json.dumps([val])
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V2",
            data=put_body,
            headers=put_header,
        )
        ...
        put_body = json.dumps([val])
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V3",
            data=put_body,
            headers=put_header,
        )
        ...
        put_body = json.dumps([val])
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V4",
            data=put_body,
            headers=put_header,
        )
...
def blynkStatusUpdate():
    ...
    try:
        ...
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/get/V49"
        )  # read button state
        myText = r.text
        ...
        put_body = json.dumps([val])
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V40",
            data=put_body,
            headers=put_header,
        )
        ...
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/get/V45"
        )  # read button state
        myText = r.text
        if myText == "[]":
            myText = "0"
        ...
        put_body = json.dumps([val])
        r = requests.put(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V39",
            data=put_body,
            headers=put_header,
        )
        ...
        # state.ValveSelector
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/get/V46"
        )  # read button state
        myText = r.text
        if myText == "[]":
            myText = "0"
        ...
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/get/V47"
        )  # read button state
        myText = r.text
        if myText == "[]":
            myText = "0"
        ...
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/get/V41"
        )  # read button state
        ...
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/get/V48"
        )  # read button state
        ...
        if DEBUGBLYNK:
            print(
                "state.WirelessDeviceSelectorPlant =", state.WirelessDeviceSelectorPlant
            )
        ...
        time.sleep(1)
        r = requests.get(
            config.BLYNK_URL + config.BLYNK_AUTH + "/update/V5?color=%2300FF00"
        )  # Green
        ...
        if state.BlinkWirelessUnit == True:
            ...
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V48?value=0"
            )
        if state.TurnOnValveButton == True:
            ...
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V41?value=0"
            )
...
def blynkAlarmUpdate():
    try:
        ...
        if state.Is_Alarm_MoistureFault:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V17?color=%23FF0000"
            )  # Red
            if DEBUGBLYNK:
            ...
            for i in range(0, config.plant_number):
                if (
                    state.Moisture_Humidity_Array[i]
                    <= state.Alarm_Moisture_Sensor_Fault
                ):
                    if config.DEBUG:
                        print(
                            "Event Print Plant #{:d}---->Moisture Sensor Fault".format(
                                i + 1
                            )
                        )
            ...
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V17?color=%2300FF00"
            )  # Green

        if state.Is_Alarm_Moisture:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V7?color=%23FF0000"
            )  # red
            if DEBUGBLYNK:
                print("blynkAlarmUpdate:OTHER:r.status_code:", r.status_code)
        else:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V7?color=%2300FF00"
            )  # Green

        if state.Is_Alarm_AirQuality:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V8?color=%23FF0000"
            )  # red
            if DEBUGBLYNK:
                print("blynkAlarmUpdate:OTHER:r.status_code:", r.status_code)
        else:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V8?color=%2300FF00"
            )  # Green

        if state.Is_Alarm_Temperature:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V9?color=%23FF0000"
            )  # red
            if DEBUGBLYNK:
                print("blynkAlarmUpdate:OTHER:r.status_code:", r.status_code)
        else:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V9?color=%2300FF00"
            )  # Green

        if state.Is_Alarm_WaterEmpty:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V16?color=%23FF0000"
            )  # red
            if DEBUGBLYNK:
                print("blynkAlarmUpdate:OTHER:r.status_code:", r.status_code)
        else:
            r = requests.get(
                config.BLYNK_URL + config.BLYNK_AUTH + "/update/V16?color=%2300FF00"
            )  # Green
